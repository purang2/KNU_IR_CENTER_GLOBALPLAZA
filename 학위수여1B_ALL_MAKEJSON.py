...
def create_Json_grade_Top10(n):
    ...
    for year in range(n,n+1):
        ...
        for i in range(0, len(school_name_list)):
            ...
            bac_tot_male+=int(male_bech)
            bac_tot_female+= int(female_bech)
            ...
            phd_tot_male += int(male_master)
            phd_tot_female += int(female_master)

            json_list2.append(temp_dictonary2)

        json_list=sorted(json_list, key=(lambda x: x['All']), reverse=True)
        json_list=json_list[0:11]
        #print(json_list)

        json_list2 = sorted(json_list2, key=(lambda x: x['All']), reverse=True)
        ...
        #if(tablename =="전자공학부" and )

    with open('result_summary_top_graduate_'+str(n)+'.json', 'w', encoding='UTF-8') as make_file:
...
#    print("학사")
#    print("(전체):", end='')
#    print(bac_tot_female+bac_tot_male)
#    print("(남자):", end='')
#    print(bac_tot_male)
#    print("(여자):", end='')
#    print(bac_tot_female)
#    print("석박사")
#    print("(전체):", end='')
#    print(phd_tot_male+phd_tot_female)
#    print("(남자):", end='')
#    print(phd_tot_male)
#    print("(여자):", end='')
#    print(phd_tot_female)
